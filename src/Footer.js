...
const Footer = () => {
  return (
    <div className="min-h-screen   bg-slate-200">
      ...
      <div className="gap-8 rounded-md lg:flex-row flex-col-reverse  flex h-full  justify-around  lg:flex">
        <div className="p-12 border shadow-lg lg:max-w-[50vw] border-gray-300 rounded-md bg-white  ">
        ...
        <div className="border shadow-lg p-4    border-gray-300 text-2xl rounded-md bg-white h-[70vh] lg:w-[20vw] flex justify-between content-around  items-center flex-col ">
